...
public class CashierMixedTest2 extends TestCase
{
	...
	public void setUp() throws Exception {
		...
		customer3 = new MockCustomer("customer4");
		orderFood1 = "chicken";
		orderFood2 = "fish";
		orderFood3 = "steak";		
	...
	public void testOneCustomerCheck() {		
		...
		cashier.msgProduceCheck(waiter1, customer3, orderFood3); //A request for the cashier to produce a check
		cashier.msgProduceCheck(waiter2, customer3, orderFood3); //A request for the cashier to produce a check
